...
export const GROUP = {
    ...
    sessionMoveStarforged: { id: 'sessionMoveStarforged', name: 'IRONSWORN.MOVES.Session Moves', type: 'system' },
    adventureMoveStarforged: { id: 'adventureMoveStarforged', name: 'IRONSWORN.MOVES.Adventure Moves', type: 'system' },
    questMoveStarforged: { id: 'questMoveStarforged', name: 'IRONSWORN.MOVES.Quest Moves', type: 'system' },
    connectionMoveStarforged: { id: 'connectionMoveStarforged', name: 'IRONSWORN.MOVES.Connection Moves', type: 'system' },
    explorationMoveStarforged: { id: 'explorationMoveStarforged', name: 'IRONSWORN.MOVES.Exploration Moves', type: 'system' },
    combatMoveStarforged: { id: 'combatMoveStarforged', name: 'IRONSWORN.MOVES.Combat Moves', type: 'system' },
    ...
    combatMoveSunderedIsles: { id: 'combatMoveSunderedIsles', name: 'IRONSWORN.MOVES.Combat Moves', type: 'system' },
    sufferMoveSunderedIsles: { id: 'sufferMoveSunderedIsles', name: 'IRONSWORN.MOVES.Suffer Moves', type: 'system' },
    recoverMoveSunderedIsles: { id: 'recoverMoveSunderedIsles', name: 'IRONSWORN.MOVES.Recover Moves', type: 'system' },
    adventureMoveClassic: { id: 'adventureMoveClassic', name: 'IRONSWORN.MOVES.Adventure Moves', type: 'system' },
    relationshipMoveClassic: { id: 'relationshipMoveClassic', name: 'IRONSWORN.MOVES.Relationship Moves', type: 'system' },
    combatMoveClassic: { id: 'combatMoveClassic', name: 'IRONSWORN.MOVES.Combat Moves', type: 'system' },
    sufferMoveClassic: { id: 'sufferMoveClassic', name: 'IRONSWORN.MOVES.Suffer Moves', type: 'system' },
    questMoveClassic: { id: 'questMoveClassic', name: 'IRONSWORN.MOVES.Quest Moves', type: 'system' },
    fateMoveClassic: { id: 'fateMoveClassic', name: 'IRONSWORN.MOVES.Fate Moves', type: 'system' },
